...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function updateHero(item) {
        ...
        // REMOVIDO: const isMobile = window.innerWidth < 768;
        ...
        setTimeout(async () => {
            ...
            // REVERTIDO: Usa apenas o backdrop horizontal ou um fallback
            const backgroundUrl = (item.backdrop && item.backdrop.startsWith('http'))
                    ? item.backdrop
    ...
    async function showDetailsView(item) {
        ...
        // REVERTIDO: const isMobile = window.innerWidth < 768;

        // REVERTIDO: Usa apenas o backdrop horizontal ou um placeholder
        const backgroundUrl = (data.backdrop && data.backdrop.startsWith('http'))
                ? data.backdrop
                : 'https://placehold.co/1280x720/0c0a09/ffffff?text=Starlight'; // Fallback final
